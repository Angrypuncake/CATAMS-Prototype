...
describe("NewCommentBox Component", () => {
  ...
  test("should render text field with placeholder", () => {
    render(<NewCommentBox value="" onChange={mockOnChange} onSubmit={mockOnSubmit} />);
  ...
  test("should display current value in text field", () => {
    render(
      <NewCommentBox value="Test comment text" onChange={mockOnChange} onSubmit={mockOnSubmit} />
    );

    const textField = screen.getByPlaceholderText("Write a comment…") as HTMLTextAreaElement;
  ...
  test("should call onSubmit when comment button is clicked", () => {
    render(<NewCommentBox value="Some comment" onChange={mockOnChange} onSubmit={mockOnSubmit} />);
