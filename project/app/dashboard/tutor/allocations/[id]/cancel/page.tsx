...
export default function Page() {
    ...
    const [replacementMode, setReplacementMode] =
        React.useState("suggest" as "suggest" | "coordinator");
    const [tutor, setTutor] = React.useState(null as null | { label: string; email: string });
                ...
                <CardHeader
                    ...
                    title={
                        <Stack direction="row" alignItems="center" spacing={1.25}>
                            ...
                            {header.timeCritical && <Chip size="small" color="error" label="Time-critical" />}
                        </Stack>
                    }
                />
                <CardContent>
            ...
            <Card>
                ...
                <CardContent>
                    <Stack spacing={3}>
                        ...
                        {/* Attachment (front-end only; not uploaded) */}
                        <Stack spacing={1}>
                            ...
                            <Typography variant="caption" color="text.secondary">
                                Optional evidence (PDF/PNG/DOC up to 5MB). Not uploaded yet.
                            </Typography>
                        </Stack>
                        ...
                        <Stack spacing={1.5}>
                            ...
                            <RadioGroup
                                ...
                                onChange={(e) => setReplacementMode(e.target.value as "suggest" | "coordinator")}
                            >
                                <FormControlLabel value="suggest" control={<Radio />} label="I will suggest a tutor" />
                                <FormControlLabel value="coordinator" control={<Radio />} label="Ask coordinator to assign" />
                            </RadioGroup>
                            ...
                            <Autocomplete
                                ...
                                renderInput={(params) => (
                                    <TextField {...params} label="Find Tutor" placeholder="Type a name or email..." />
                                )}
                                disabled={replacementMode !== "suggest"}
                            />
                            <Typography variant="caption" color="text.secondary">
                                Search eligible tutors in this unit. Selecting a tutor will be stored locally for now.
                            </Typography>
                        </Stack>
                        ...
                        <FormControlLabel
                            ...
                            label={
                                <Typography variant="body2">
                                    I understand this cancellation may leave the session unassigned and the coordinator may contact me for clarification.
                                </Typography>
                            }
                        />
