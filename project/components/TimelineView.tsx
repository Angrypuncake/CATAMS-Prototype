...
export function TimelineView<A extends ActivityRow = ActivityRow>({
    ...
    const tooltipContent = (
        ...
        <div className="text-[12px] leading-5">
            ...
            <div className="mt-2 border-t pt-1 text-[11px] text-gray-600">
                <div>
            ...
            {/* Inline edit button (only shown for non-empty cells) */}
            {onEdit && (
                <div className="mt-2">
                    <button
                        type="button"
                        className="w-full rounded-md border border-gray-300 bg-white px-2 py-1 text-[12px] font-medium hover:bg-gray-50"
                        onClick={onEdit}
                    >
                                ...
                                >
                                    <div className="grid" style={{ gridTemplateColumns: leftGridTemplate }}>
                                        ...
                                        <div
                                            ...
                                            style={{ height: rowH }}
                                        >
                                            <span className="shrink-0 rounded-md bg-indigo-600/10 text-indigo-700 px-2 py-0.5 text-[10px] font-semibold">
                                        ...
                                        {weeks.map((w) => {
                                            ...
                                            return (
                                                <Tooltip
                                                    ...
                                                    title={
                                                        items.length
                                                            ? tooltipContent(
                                                                ...
                                                                items,
                                                                onCellEdit
                                                                    ? () => onCellEdit({ activity: act as A, week: w, cell: items })
                                                                    : undefined
                                                            )
                                                            : "No allocation"
                                                    }
                                                    arrow
                                                    placement="top"
                                                    disableInteractive={!items.length}
                                                    enterDelay={120}
                                                    componentsProps={{
                                                        tooltip: {
                                                            sx: {
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {items.length ? (
                                                            // STACKED single-line badges (separate per instance). Two shown max; then "+N more".
